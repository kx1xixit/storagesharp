...
Restore a namespace from a previously exported string. If an encryption key is set, the input is decrypted first; if decryption fails the import is aborted silently.
